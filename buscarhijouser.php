...
// Prepare the query to count the total number of records
...
// Prepare the query to fetch the paginated results
$stmt = $conexion->prepare("SELECT * FROM articulos WHERE categoriapadre = :name1 AND categoriahijo = :name2 LIMIT :inicio, :regs");
$stmt->bindParam(':name1', $name1, PDO::PARAM_STR);
$stmt->bindParam(':name2', $name2, PDO::PARAM_STR);
$stmt->bindParam(':inicio', $inicio, PDO::PARAM_INT);
$stmt->bindParam(':regs', $REGS, PDO::PARAM_INT);
$stmt->execute();
