...
<div class="padre d-flex flex-row" style="width:100%;height:auto;">
    <div class="hijo1" style="width: 12%;">
        <?php include("side.php") ?>
    </div>
    <div class=" hijo2  d-flex flex-column " style="width:950px;font-size: 16px; ">
    ...
    <div class="hijo3" style="width: 14%;">
        <ul class="list-group pt-4 ">
            <li class="list-group-item border-0 border-bottom"><a href="index.php">Iniciar sesion</a></li>
...
if (isset($_POST['envier'])) {
    ...
    if (!validarDNI($dni)) {
        ...
        echo "<div class='alerta'>
                <h5>¡el dni " . $dni . " esta registrado, inicia session para entra!</h5>
                <button class='cerrar-btn' onclick='cerrarAlerta()'>Cerrar</button> </div>
                <script> function cerrarAlerta() { document.querySelector('.alerta').style.display='none';}</script>";
        ...
        $socio = new Socio($dni, $nombre, $direccion, $localidad, $provincia, $telefono, $email, $contrasena,$activo);
