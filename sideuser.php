...
if ($result_padre->num_rows > 0) {
    ...
    while($row_padre = $result_padre->fetch_assoc()) {
      echo "<li> <a href='buscarpadreuser.php?name=". $row_padre["name"] ."'>". $row_padre["name"] ."</a></li>";
        ...
        if ($result_hijas->num_rows > 0) {
            ...
            while($row_hija = $result_hijas->fetch_assoc()) {
                 ...
                 echo "<li> <a href='buscarhijouser.php?name=". $row_hija["name"] ."'>". $row_hija["name"] ."</a></li>";
            }
    ...
    echo "<div class='alerta'>
            <h5>!No se encontraron categorías padre¡</h5>
